...
public class Bill {
    ...
    public Bill(Double quantity, Double price, int tax, String text,int paymentMethodType,int paymentSubjectType,
        ...
        this.plannedStatus=(plannedStatus==null)?0:plannedStatus;
        this.supplierInfo=supplierInfo;
        this.supplierINN=supplierINN;
        this.agentType=agentType;
        this.agentInfo=agentInfo;
        this.unitOfMeasurement=unitOfMeasurement;
        this.quantityMeasurementUnit=(quantityMeasurementUnit==null)?0:quantityMeasurementUnit;
        this.additionalAttribute=additionalAttribute;
        this.manufacturerCountryCode=manufacturerCountryCode;
        this.customsDeclarationNumber=customsDeclarationNumber;
        this.excise=(excise==null)?0:excise;
        this.taxSum=(taxSum==null)?0:taxSum;
        this.unitTaxSum=(unitTaxSum==null)?0:unitTaxSum;
